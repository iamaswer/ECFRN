...
class Train_Manager:
    ...
    def __init__(self,args,path_manager,train_func,modelLinear):
        ...
        self.logger = get_logger('model%s.log' % (name))
        self.save_path = 'model%s.pth' % (name)
        self.writer = SummaryWriter('model_%slog' % (name))
